    ...
    if request.method == "POST" and form.is_valid():
        ...
        if usuario:
            ...
            html = ('<p style="font-size:12px;">Estimada/o Proveedor</p>'
                    '<p style="font-size:12px;">Se registró el alta de su cuenta de Usuario de Proveedor. Para reimprimir su Declaración Jurada haga clic en el siguiente link.<br>'
                    '<a  href="http://45.186.124.66/sistema/declaracionJurada?a=' + a + '">Reimprimir Declaración Jurada</a><br> </p>'
